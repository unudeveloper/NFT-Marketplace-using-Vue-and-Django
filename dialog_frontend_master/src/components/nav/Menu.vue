...
<div class='menu-navbar'>
  <div class="top-menu-container">
    ...
    <div class="test-menu">
      <span id="topnav" class="dropdown"><router-link :to='{ name: "Collections" }'>Collections</router-link>
        <span class='active' >
          <router-link :to='{ name: "Active" }'>Active</router-link>
            <li v-for='title in series' :key='title.col_title' :slug="title.col_slug"><router-link :to="{ name: 'Serie', params: { slug: title.collection_id } }">{{title.col_title}}</router-link></li>
        </span>
      </span>
